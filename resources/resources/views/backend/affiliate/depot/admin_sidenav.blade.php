...
{{--                @endif--}}
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="badge badge-info" style="margin-right: 3px">{{ \App\Models\User::where('user_type','customer')->count() }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
            ...
            <!-- Customers -->
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Gift')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('gift.giftRequest')}}" class="aiz-side-nav-link {{ areActiveRoutes(['gift.giftRequest'])}}">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item ">
                        <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['warranty_card.index', 'warranty_card.show'])}}">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item ">
                                <a href="{{ route('warranty_card.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['warranty_card.index', 'warranty_card.show'])}}">
                                    <span class="aiz-side-nav-text">{{translate('List of Warranty')}}</span>
                                    <span class="badge badge-info" style="margin-right: 3px">{{ \App\Models\WarrantyCard::count() }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('warranty_codes.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['warranty_codes.index'])}}">
                                    <span class="aiz-side-nav-text">{{translate('All warranty code')}}</span>
                                    <span class="badge badge-info" style="margin-right: 3px"></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('warranty_codes.bulk-warranty-code') }}" class="aiz-side-nav-link {{ areActiveRoutes(['warranty_codes.bulk-warranty-code'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Import warranty ')}}</span>
                                    <span class="badge badge-info" style="margin-right: 3px"></span>
                                </a>
                            </li>
                        </ul>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('22', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('uploaded-files.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['uploaded-files.create'])}}">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Upload File')}}</span>
                        </a>
                    </li>
                @endif
...
{{--                            @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))--}}
{{--                                <li class="aiz-side-nav-item">--}}
{{--                                    <a href="{{ route('banner.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['banner.index', 'banner.create', 'banner.edit'])}}">--}}
...
{{--                            </li>--}}
                            <li class="aiz-side-nav-item">
                                <a href="{{route('affiliate.depot.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.depot.index', 'affiliate.depot.create', 'affiliate.depot.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Depot')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('affiliate.employee.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.employee.index', 'affiliate.employee.create', 'affiliate.employee.edit'])}}">
...
{{--                @endif--}}
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('news.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['news.index', 'news.create', 'news.edit'])}}">
