            ...
            <form action="{{ route('staffs.update', $staff->id) }}" method="POST">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Tên')}}" id="name" name="name" value="{{ $staff->user->name }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Số điện thoại')}}" id="mobile" name="mobile" value="{{ $staff->user->phone }}" class="form-control" required>
                            @error('mobile')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" placeholder="{{translate('Mật khẩu')}}" id="password" name="password" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
