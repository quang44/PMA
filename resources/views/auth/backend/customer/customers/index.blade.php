            ...
            <div class="table-responsive">
                <table class="table aiz-table mb-0">
                    ...
                    <tr>
                        ...
                        <th data-breakpoints="lg">{{translate('Information')}}</th>
                        <th data-breakpoints="lg">{{translate('Bank account')}}</th>
                        <th data-breakpoints="lg">{{translate('Status')}}</th>
                        <th data-breakpoints="lg">{{translate('Created_at')}}</th>
                        <th data-breakpoints="lg">{{translate('Updated_at')}}</th>
                        ...
                        @if ($user != null)
                            ...
                            <!--                                <td>
                                ...
                                <td><a title="lịch sử thanh toán"
                                       href="{{route('customers.historyPayment',encrypt($user->id))}}">{{$user->name}}</a>
                                </td>
                                <td>
                                    {{translate('Phone')}} : {{$user->phone}} <br>
                                    {{translate('Email')}} : {{$user->email}} <br>
                                    {{translate('Address')}} :
