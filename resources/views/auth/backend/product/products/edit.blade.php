...
{{--                        </div>--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" value="{{old('warranty_duration ',$product->warranty_duration)}}"  name="warranty_duration" lang="vn" class="form-control"  required>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <textarea style="display: block!important;" class="aiz-text-editor" name="description"> {{ $product->getTranslation('description', $lang) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
