            ...
            <div class="card">
                ...
                <div class="card-body align-content-center">
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="package_id">{{translate('Name')}} :</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <span>{{date('d-m-Y H:i:s',strtotime($gift->created_time==null?'':$gift->created_time))}}</span>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="Seri">{{translate('Active Time')}} :</label>
                        <div class="col-sm-9">
                            <span>{{date('d-m-Y H:i:s',strtotime($gift->active_time==null?'--':$gift->active_time))}}</span>
                        </div>
                    </div>
