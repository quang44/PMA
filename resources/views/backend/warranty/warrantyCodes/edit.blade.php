                        ...
                        <div class="form-group row">
                            ...
                            <div  class="col-sm-9">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input  data-toggle="tooltip" name="status" value="{{$warranty_code->status}}" type="checkbox" @if($warranty_code->status==1)  @else checked disabled @endif onclick="ChangeStatus( {{$warranty_code->id}},{{$warranty_code->status}})" >
