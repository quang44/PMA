        ...
        <div class="col-lg-6 mx-auto">
            <div class="card">
                ...
                <div class="card-body align-content-center">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="Seri">{{translate('Ngày tạo')}} :</label>
                        <div class="col-sm-9">
                            <span>{{date('d-m-Y H:i:s',strtotime($warranty_card->created_at))}}</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-from-label" for="Seri">{{translate('Thời gian kích hoạt')}}
                            :</label>
                        <div class="col-sm-9">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light"
                                data-bs-dismiss="modal">{{translate('Hủy')}}</button>
