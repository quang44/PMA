...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" href="{{static_asset('assets/img/faviconpma.jpg')}}">
	<title>{{ translate('PMA') }}</title>
    ...
    <link rel="stylesheet" href="{{static_asset('assets/css/magnific-popup.min.css')}}">
    <style>
        body {
            font-size: 12px;
        }
