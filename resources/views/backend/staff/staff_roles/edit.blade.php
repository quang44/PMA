                ...
                <form class="p-4" action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-10">
                                    <label class="col-from-label">{{ translate('Đơn hàng') }}</label>
                                </div>
                                <div class="col-md-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="permissions[]" class="form-control demo-sw"
                                               value="3" @php if(in_array(3, $permissions)) echo "checked"; @endphp>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <label class="col-from-label">{{ translate('Kế toán') }}</label>
                                </div>
                                <div class="col-md-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <label class="col-from-label">{{ translate('Shop') }}</label>
                                </div>
                                <div class="col-md-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="permissions[]" class="form-control demo-sw"
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <label class="col-from-label">{{ translate('Hỗ trợ') }}</label>
                                </div>
                                <div class="col-md-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="permissions[]" class="form-control demo-sw"
                                               value="12" @php if(in_array(12, $permissions)) echo "checked"; @endphp>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <label class="col-from-label">{{ translate('Tiếp thị liên kết') }}</label>
                                </div>
                                <div class="col-md-2">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="permissions[]" class="form-control demo-sw"
                                               value="15" @php if(in_array(15, $permissions)) echo "checked"; @endphp>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
