...
<!--                                <td>
                                ...
                                <td>{{$user->email}}</td>
                                <td><a href="{{ route('affiliate.kol.index', ['referred_by' => $user->id])}}">{{$user->phone}}</a></td>
                                <td>
                                    {{ $user->referral_code }}
                                </td>
                                <td class="text-right">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>{{translate('Bạn muốn khóa tài khoản nhân viên?')}}</p>
            </div>
...
<div class="modal fade" id="confirm-unban">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>{{translate('Bạn muốn kích hoạt tài khoản cho nhân viên?')}}</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-dismiss="modal">{{translate('Cancel')}}</button>
