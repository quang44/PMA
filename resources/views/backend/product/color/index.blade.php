                    ...
                    <table class="table aiz-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th>{{ translate('Warranty duration') }}</th>
                        ...
                        <span class='size-15px d-inline-block mr-2 rounded border' style='background:{{$color->code}}'></span>
                                    ...
                                    <td> @if($color->warranty_duration!=null) {{$color->warranty_duration  }} tháng ({{timeWarranty($color->warranty_duration) }}) @endif</td>
                                    <td class="text-right">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('colors.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="color" placeholder="{{ translate('Color Code') }}" id="code" name="code"
                                class="form-control" value="{{ old('code') }}" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">{{ translate('Warranty duration') }}</label>
                            <input type="number" placeholder="Nhập số tháng" id="code" name="warranty_duration"
                                   class="form-control" value="{{ old('warranty_duration') }}" required>
                        </div>
