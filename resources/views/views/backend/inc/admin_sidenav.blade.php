    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-center">
                ...
                {{--                @else--}}
                <img class="w-130px" style="height: 120px!important;" src="{{ static_asset('assets/img/photo_2022-12-05_10-35-43.jpg') }}"
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('9', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item ">
                        <a href="{{ route('warranty_card.index') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['warranty_card.index', 'warranty_card.show'])}}">
                            ...
                            <span class="badge badge-info"
                                  style="margin-right: 3px">{{ \App\Models\WarrantyCard::count() }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Management')}} {{translate('Customers')}}</span>
                            <span class="badge badge-info"
                                  style="margin-right: 3px">{{ \App\Models\User::where('user_type','customer')->count() }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Customer Account')}}</span>
                                </a>
                            </li>
                            {{--                            <li class="aiz-side-nav-item">--}}
                            ...
                            {{--                                    <span class="aiz-side-nav-text">{{translate('Customer Groups')}}</span>--}}
                            {{--                                </a>--}}
                            {{--                            </li>--}}
            ...
            <!-- Customers -->
                @if(Auth::user()->user_type == 'admin' || in_array('24', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Management')}} {{translate('Gift')}}</span>
                            <span class="badge badge-info" style="margin-right: 3px">{{ \App\Models\GiftRequest::count() }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{route('gift.index')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('List of gift')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('gift.giftRequest')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['gift.giftRequest'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Request gift exchange')}}</span>
                                    <span class="badge badge-info" style="margin-right: 3px">{{ \App\Models\GiftRequest::count() }}</span>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('9', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item ">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('warranty_codes.index') }}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['warranty_codes.index'])}}">
                                    <span class="aiz-side-nav-text">Quản lý mã bảo hành</span>
                                    <span class="badge badge-info" style="margin-right: 3px"></span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('product_warranty.index')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['product_warranty.index','product_warranty.create','product_warranty.edit'])}}">
...
{{--                            <span class="aiz-side-nav-text">Quản lý san pSản phẩm</span>--}}
{{--                            <span class="aiz-side-nav-arrow"></span>--}}
{{--                        </a>--}}
...
{{--                            <li class="aiz-side-nav-item">--}}
{{--                                <a href="{{route('products.all')}}" class="aiz-side-nav-link">--}}
{{--                                    <span class="aiz-side-nav-text">{{translate('Management')}} {{ translate('Product  Introduction') }}</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="aiz-side-nav-item">--}}
...
{{--                <li class="aiz-side-nav-item">--}}
{{--                    <a href="{{ route('order_delivery.index') }}" class="aiz-side-nav-link">--}}
{{--                        <i class="las la-money-bill aiz-side-nav-icon"></i>--}}
{{--                        <span class="aiz-side-nav-text">{{translate('Đơn hàng')}}</span>--}}
{{--<!--                        <span class="aiz-side-nav-arrow"></span>-->--}}
{{--                    </a>--}}
{{--                    <!--Submenu-->--}}
{{--                    <ul class="aiz-side-nav-list level-2">--}}
...
{{--                        @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))--}}
{{--                            <li class="aiz-side-nav-item">--}}
{{--                                <a href="{{ route('order_delivery.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['order_delivery.index', 'order_delivery.show'])}}">--}}
{{--                                    <span class="aiz-side-nav-text">{{translate('Đơn hàng')}}</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                        @endif--}}
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('29', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('depot')}} - {{translate('Agent')}} </span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            {{--                            <li class="aiz-side-nav-item">--}}
                            ...
                            {{--                            </li>--}}
                            <li class="aiz-side-nav-item">
                                <a href="{{route('affiliate.depot.index')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.depot.index', 'affiliate.depot.create', 'affiliate.depot.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('depot')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('affiliate.employee.index')}}"
                                   class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.employee.index', 'affiliate.employee.create', 'affiliate.employee.edit'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Agent')}}</span>
                                </a>
                            </li>
                            {{--                            <li class="aiz-side-nav-item">--}}
                            {{--                                <a href="{{route('affiliate.kol.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.kol.index', 'affiliate.kol.create', 'affiliate.kol.edit'])}}">--}}
                            {{--                                    <span class="aiz-side-nav-text">{{translate('Collaborators')}}</span>--}}
                            {{--                                </a>--}}
                            {{--                            </li>--}}
                            {{--                            <li class="aiz-side-nav-item">--}}
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('news.index') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['news.index', 'news.create', 'news.edit'])}}">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Management')}} {{translate('News')}}</span>
                        </a>
                    </li>
                @endif
...
{{--                            <span class="aiz-side-nav-text">{{ translate('Kế toán') }}</span>--}}
{{--                            <span class="aiz-side-nav-arrow"></span>--}}
{{--                        </a>--}}
{{--                        <ul class="aiz-side-nav-list level-2">--}}
{{--                            <li class="aiz-side-nav-item">--}}
{{--                                <a href="{{ route('customers.customer_pay') }}" class="aiz-side-nav-link">--}}
{{--                                    <span class="aiz-side-nav-text">{{ translate('Đối soát cho shop') }}</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="aiz-side-nav-item">--}}
{{--                                <a href="{{ route('customer_bill.index') }}" class="aiz-side-nav-link">--}}
{{--                                    <span class="aiz-side-nav-text">{{ translate('Phiếu đối soát shop') }}</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="aiz-side-nav-item">--}}
{{--                                <a href="{{ route('partner_bill.create') }}" class="aiz-side-nav-link">--}}
...
{{--                @endif--}}
            ...
            <!-- Reports -->
                ...
                {{--                            <span class="aiz-side-nav-text">{{translate('Wallet Money')}}</span>--}}
                {{--                            <span class="aiz-side-nav-arrow"></span>--}}
                {{--                        </a>--}}
                {{--                        <ul class="aiz-side-nav-list level-2">--}}
                {{--                            <li class="aiz-side-nav-item">--}}
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <a href="{{ route('banner.index') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['banner.index', 'banner.create', 'banner.edit'])}}">
                            <i class="las la-image aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('Management')}} {{ translate('Banners') }}</span>
                        </a>
                    </li>
                    {{--                                <li class="aiz-side-nav-item">--}}
                    {{--                                    <a href="{{ route('popup.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['popup.index', 'popup.create', 'popup.edit'])}}">--}}
                    {{--                                        <span class="aiz-side-nav-text">{{ translate('Popup') }}</span>--}}
                    {{--                                    </a>--}}
                    {{--                                </li>--}}
                    {{--                            @endif--}}
                    {{--                            @if(Auth::user()->user_type == 'admin' || in_array('7', json_decode(Auth::user()->staff->role->permissions)))--}}
                    ...
                    {{--                                    </a>--}}
                    {{--                                </li>--}}
                    {{--                                @if (addon_is_activated('otp_system'))s--}}
                    {{--                                    <li class="aiz-side-nav-item">--}}
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('14', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('common_configs.index') }}" class="aiz-side-nav-link" >
                            ...
                            <span class="aiz-side-nav-text">{{translate('Common Config')}}</span>
                        </a>
{{--                        <ul class="aiz-side-nav-list level-2">--}}
{{--                            <li class="aiz-side-nav-item">--}}
{{--                                <a href="{{ route('common_configs.index') }}" class="aiz-side-nav-link">--}}
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('20', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Management')}}  {{translate('Employee')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
...
{{--                           class="aiz-side-nav-link {{ areActiveRoutes(['banks.index', 'banks.create', 'banks.store', 'banks.show', 'banks.edit'])}}">--}}
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('27', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('website.pages') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['website.pages'])}}">
                            <i class="las la-pager aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('All pages')}}</span>
                        </a>
                    </li>
                @endif
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('30', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('admin.all-notification') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['admin.all-notification'])}}">
                            <i class="las la-newspaper aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('Management')}} {{translate('Notifications')}}</span>
                        </a>
                    </li>
                @endif
                {{--                <li class="aiz-side-nav-item">--}}
