        ...
        <div class="col-lg-6 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">Thêm mới thông báo</h5>
                </div>
...
{{--                        </div>--}}
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label" for="email">{{translate('Type')}} <span
                                    class="text-danger"> *</span> </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label" for="email">{{translate('Content')}} <span
                                    class="text-danger"> *</span> </label>
                            <div class="col-sm-9">
					<textarea
                        class=" form-control  "
