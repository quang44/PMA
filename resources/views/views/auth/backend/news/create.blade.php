...
<div class="card">
	<form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
		...
		<div class="card-header">
			<h6 class="fw-600 mb-0">{{ translate('Thông tin bài viết') }}</h6>
		</div>
		<div class="card-body">
			<div class="form-group row">
				<label class="col-sm-2 col-from-label" for="name">{{translate('Tiêu đề')}} <span class="text-danger">*</span></label>
				<div class="col-sm-10">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label" for="signinSrEmail">Ảnh bài viết</small></label>
                <div class="col-sm-10">
...
<!--			<div class="form-group row">
			...
			<div class="text-right">
				<button type="submit" class="btn btn-primary">{{ translate('Thêm bài viết') }}</button>
			</div>
		</div>
	</form>
</div>
