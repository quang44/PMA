...
<div class="row content{{$i}}">
    ...
    <div class="col-4">
        <div class="form-group ">
            ...
            <select name="district[]" id="district{{$i}}" data-district="{{$i}}"  class="district form-control aiz-selectpicker"  data-selected-text-format="count" data-live-search="true" disabled></select>
        </div>
    </div>
