...
{{--                        </div>--}}
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" lang="vn" class="form-control" name="min_qty" value="1" min="1" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Warranty duration')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" name="warranty_duration" lang="vn" class="form-control"  required>
                            </div>
                        </div>
                        <div class="form-group row">
