...
//        Route::get('user/notification', 'App\Http\Controllers\Api\V2\AuthController@notification');
        ...
        Route::get('user/update-to-agent', 'App\Http\Controllers\Api\V2\AuthController@update_to_agent');
        Route::get('user/update-to-depot', 'App\Http\Controllers\Api\V2\AuthController@update_to_depot');
...
//    Route::get('wards-by-district/{district_id}', 'App\Http\Controllers\Api\V2\AddressController@getWardsByDistrict');
    ...
    Route::group(['prefix' => 'user_manual', 'middleware' => []], (function () {
        Route::get('', 'App\Http\Controllers\Api\V2\UserManualController@index');
       // Route::get('/{id}', 'App\Http\Controllers\Api\V2\NewsController@show')->where('id', '[0-9]+');
    }));
    ...
    Route::group(['prefix' => 'address', 'middleware' => ['auth:sanctum']], (function () {
        ...
        Route::get('', 'App\Http\Controllers\Api\V2\AddressController@index');
        Route::get('/{id}', 'App\Http\Controllers\Api\V2\AddressController@show')->where('id', '[0-9]+');
        Route::get('/default', 'App\Http\Controllers\Api\V2\AddressController@showDefault');
        Route::post('create', 'App\Http\Controllers\Api\V2\AddressController@store');
        Route::post('edit/{id}', 'App\Http\Controllers\Api\V2\AddressController@update');
        Route::post('delete/{id}', 'App\Http\Controllers\Api\V2\AddressController@delete');
    }));

    Route::group(['prefix' => 'order', 'middleware' => ['auth:sanctum']], (function () {
        Route::get('', 'App\Http\Controllers\Api\V2\OrderDeliveryController@index');
        Route::get('{id}', 'App\Http\Controllers\Api\V2\OrderDeliveryController@show')->where('id', '[0-9]+');
        Route::post('create', 'App\Http\Controllers\Api\V2\OrderDeliveryController@store');
        Route::post('cancel/{id}', 'App\Http\Controllers\Api\V2\OrderDeliveryController@cancel');
        Route::post('update/{id}', 'App\Http\Controllers\Api\V2\OrderDeliveryController@update');
        Route::post('update-address/{id}', 'App\Http\Controllers\Api\V2\OrderDeliveryController@updateAddress');
        Route::post('fee', 'App\Http\Controllers\Api\V2\OrderDeliveryController@fee');
        Route::post('shop-fee', 'App\Http\Controllers\Api\V2\OrderDeliveryController@feeShop');
        Route::post('print', 'App\Http\Controllers\Api\V2\OrderDeliveryController@printBill');
        Route::get('report', 'App\Http\Controllers\Api\V2\OrderDeliveryController@report');
        Route::get('report-monthly', 'App\Http\Controllers\Api\V2\OrderDeliveryController@reportMonthly');
    }));

    Route::group(['prefix' => 'bill', 'middleware' => ['auth:sanctum']], (function () {
        Route::get('', 'App\Http\Controllers\Api\V2\BillController@index');
        Route::get('{id}', 'App\Http\Controllers\Api\V2\BillController@show')->where('id', '[0-9]+');
    }));

    Route::group(['prefix' => 'ticket', 'middleware' => ['auth:sanctum']], (function () {
        Route::get('', 'App\Http\Controllers\Api\V2\TicketController@index');
        Route::get('{id}', 'App\Http\Controllers\Api\V2\TicketController@show')->where('id', '[0-9]+');
        Route::post('', 'App\Http\Controllers\Api\V2\TicketController@store');
    }));

    Route::group(['prefix' => 'customer-bank', 'middleware' => ['auth:sanctum']], (function () {
    ...
    Route::group(['prefix' => 'banner', 'middleware' => []], (function () {
        Route::get('', 'App\Http\Controllers\Api\V2\BannerController@index');
        Route::get('/{id}', 'App\Http\Controllers\Api\V2\BannerController@show');
    }));

    Route::group(['prefix' => 'popup', 'middleware' => ['auth:sanctum']], (function () {
        Route::get('', 'App\Http\Controllers\Api\V2\PopupController@index');
    }));


        Route::get('depot', 'App\Http\Controllers\Api\V2\AffiliateController@listDepot');
        Route::get('agent', 'App\Http\Controllers\Api\V2\AffiliateController@listAgent');
    Route::group(['prefix' => 'affiliate', 'middleware' => ['auth:sanctum']], (function () {
        ...
        Route::get('static', 'App\Http\Controllers\Api\V2\AffiliateController@static');
        Route::get('order_static', 'App\Http\Controllers\Api\V2\AffiliateController@order_static');
        Route::get('payment_static', 'App\Http\Controllers\Api\V2\AffiliateController@payment_static');
        Route::get('orders', 'App\Http\Controllers\Api\V2\AffiliateController@orders');
        Route::get('order-detail', 'App\Http\Controllers\Api\V2\AffiliateController@order_detail');
    }));
...
//    });
    ...
    Route::apiResource('customers', 'App\Http\Controllers\Api\V2\CustomerController')->only('index','show');
        Route::get('agent-by-depot/{id}','App\Http\Controllers\Api\V2\CustomerController@getAgent');
        Route::get('address-by-agent/{id}','App\Http\Controllers\Api\V2\CustomerController@getAddressAgent');
    ...
    Route::get('color-by-product/{id}','App\Http\Controllers\Api\V2\ProductController@color_by_product');
    Route::get('product_by_variant/{id}','App\Http\Controllers\Api\V2\ProductController@product_by_variant');
     Route::get('qty-by-color/{id}','App\Http\Controllers\Api\V2\ProductController@qty_by_color');
    ...
    Route::get('product_warranty', 'App\Http\Controllers\Api\V2\ProductController@warranty_product');
...
//    Route::get('wallet/balance', 'App\Http\Controllers\Api\V2\WalletController@balance')->middleware('auth:sanctum');
    ...
    Route::get('pickup-list', 'App\Http\Controllers\Api\V2\ShippingController@pickup_list');
        ...
        Route::group(['middleware' => 'auth:sanctum'], (function () {
            Route::apiResource('gifts', 'App\Http\Controllers\Api\V2\GiftController')->only('index','store','show','destroy');
            Route::post('gifts/request','App\Http\Controllers\Api\V2\GiftController@request');
            Route::get('gift/list-request','App\Http\Controllers\Api\V2\GiftController@showRequest');
            Route::get('gift/list-request/{id}','App\Http\Controllers\Api\V2\GiftController@giftDetail');
            Route::get('gift/cancel/{id}','App\Http\Controllers\Api\V2\GiftController@cancelRequest');
        }));
