...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/dang-ky-shop', 'registration')->name('user.registration');
    Route::get('/dang-ky-cong-tac-vien', 'registrationKol')->name('user.registrationKol');
    Route::post('/createKol', 'createKol')->name('user.createKol');
    Route::get('/dang-ky-shop-thanh-cong', 'registration_success')->name('user.registration_success');
    Route::post('/users/login/cart', 'cart_login')->name('cart.login.submit');
    Route::get('/ctv', 'hdctv');

    //Home Page
    Route::get('/tai-ung-dung', 'installApp')->name('installApp');
...
Route::controller(PageController::class)->group(function () {
    ...
    Route::get('news/{slug}', 'show_news')->name('news.show');
});

Route::group(['prefix' => 'hook'], (function () {
    Route::post('order/best-express', 'App\Http\Controllers\Hook\OrderDeliveryController@bestExpress');
}));
