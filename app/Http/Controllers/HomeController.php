...
class HomeController extends Controller
{
    ...
    public function installApp(){
        ...
        if($agent->isiPhone() || $agent->isiPad()){
            return redirect()->to('https://apps.apple.com/us/app/gomdon/id1634363930');
        }
        if($agent->isAndroidOS()){
            return redirect()->to('https://play.google.com/store/apps/details?id=gomdon.com.vn');
        }
    ...
    public function hdctv(){
        $agent = new Agent();
        if($agent->isPhone()){
            return view('frontend.ctv_mobile');
        }
        return view('frontend.ctv');
    }
    ...
    public function registrationKol(){
        $agent = new Agent();
        if($agent->isPhone()){
            return view('frontend.kol_registration_mobile');
        }
        return view('frontend.kol_registration');
    }
    ...
    public function registration_success(){
        ...
        $url = null;
        if($agent->isiPhone() || $agent->isiPad()){
            $url = 'https://apps.apple.com/us/app/gomdon/id1634363930';
        }
        if($agent->isAndroidOS()){
            $url = 'https://play.google.com/store/apps/details?id=gomdon.com.vn';
        }
        return view('frontend.user_registration_success', compact('url'));
    }
