    ...
    public static function sendFirebaseNotification($req)
    {
        ...
        (
            ...
            'data' => [
                'item_type' => $req->type,
                'item_type_id' => $req->id,
                'best_api_user' => $req->best_api_user ?? '',
                'click_action' => 'FLUTTER_NOTIFICATION_CLICK'
            ]
        );

        //$fields = json_encode($arrayToSend);
        $key = "AAAA1Z3sdaQ:APA91bH06BcvkdvmGcgIguOiD2j7lNilKqr5G-2BKolF9R-EMFT4twwl2JAsxImqKimRB0ia-57nOqyPYGVsIidWIeV_RRvwSZyQaWSRt7lTAB6RfG_AvpUF_io6oy2sFeFvXFrateoU";
        $headers = array(
        ...
        $firebase_notification->receiver_id = $req->device_token;
