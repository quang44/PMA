...
<?php
    $lang=\App\Models\Language::where('code', Session::get('locale', Config::get('app.locale')))->first();

    ?>
<?php if(!is_null($lang) && $lang->rtl == 1): ?>
...
<?php /**PATH F:\PHP\PMA\resources\views/backend/layouts/layout.blade.php ENDPATH**/ ?>