                    ...
                    <div class="  row">
                        ...
                        <table class="table aiz-table mb-0">
                            ...
                            <tr>
                                ...
                                <th data-breakpoints="lg"><?php echo e(translate('Action')); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(!$detail->color): ?>
                                        ...
                                        <p>Thời gian bảo hành (<?php echo e(timeWarranty($detail->color->warranty_duration)); ?>)</p>
                                        <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <?php if($warranty_card->status==0 && $detail->status==0): ?>
                                        <a href="javascript:void(0)"
                                           class="btn btn-soft-danger btn-icon btn-circle btn-sm"
                                           onclick="confirm_ban('<?php echo e(route('warranty_card.ban_detail', encrypt($detail->id))); ?>' ,2);"
