<!doctype html>
   ...
   $Language= \App\Models\Language::where('code', Session::get('locale','vn'))->first();
 ?>
...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" href="<?php echo e(static_asset('assets/img/faviconpma.jpg')); ?>">
	<title><?php echo e(translate('PMA')); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(static_asset('assets/css/magnific-popup.min.css')); ?>">
    <style>
        body {
            font-size: 12px;
        }
...
<body class="">
    ...
    <script src="<?php echo e(static_asset('assets/js/jquery.magnific-popup.min.js')); ?>" ></script>
				...
				if(items.length > 0){
					for (i = 0; i < items.length; i++) {
						...
						const link = $(items[i]).attr('href');
						 $("#search-menu").append(`<li class="aiz-side-nav-item">
...
<?php /**PATH F:\PHP\PMA\resources\views/backend/layouts/app.blade.php ENDPATH**/ ?>